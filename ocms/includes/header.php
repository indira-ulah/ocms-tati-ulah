...
<div class="humberger__menu__wrapper">
    <div class="humberger__menu__logo">
        <a href="index.php"><h3>BARCODE</h3></a>
    </div>
    <div class="humberger__menu__cart">
        <div class="header__cart__price">Item: 
            <span><?php echo "₱ " . number_format(isset($_SESSION['tprice']) ? $_SESSION['tprice'] : 0, 2); ?></span>
        </div>
    </div>
    <div class="humberger__menu__widget">
        <?php if (empty($_SESSION['ocmsuid'])) { ?>
    ...
    <div class="header__top__right__social">
        <a href="https://www.facebook.com/barcode.zamboanga"><i class="fa fa-facebook"></i></a>
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="header__logo">
                    <a href="index.php"><h3><strong>BARCODE</strong></h3></a>
                </div>
            </div>
            <div class="col-lg-6">
